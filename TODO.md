...
- [ ] Step 2b: Update `src/app/profile/edit/page.tsx` for file upload + preview + current data load
- [x] Step 3: Update `src/app/profile/[id]/page.tsx` to display profile image in Avatar
- [ ] Step 4: Test upload and display (run `npm run dev`, go to /profile/edit)
